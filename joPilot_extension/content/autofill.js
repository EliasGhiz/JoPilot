...
const simplifyLabel = (text) => {
  ...
  const generalizedMappings = {
    ...
    "preferred name": ["preferredname", "nickname", "alias", "displayname"],
    ...
    "phone number": ["phone", "phonenumber", "contactnumber", "mobile", "mobilephone", "cellphone", "telephone", "primarycontactnumber", "primary phone number"],
    "phone type": ["phone device type", "primary phone type", "phonetype"],
    "address": ["address", "streetaddress", "homeaddress", "mailingaddress", "residentialaddress", "addressline1"],
